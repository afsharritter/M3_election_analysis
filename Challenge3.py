...
file_to_load = os.path.join('M3_PyPoll\M3_election_analysis\Resources\election_results.csv')
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > largest_county_votes) and (county_percentage > largest_county_percentage):
    ...
    largest_county_summary = (
        ...
        f"Largest County Vote Count: {largest_county_votes:,}\n"
